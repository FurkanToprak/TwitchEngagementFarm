...
class Bot:
    ...
    def getChannel(self) -> Union[None, Channel.Channel]:
        return self.channel
    ...
    def followChannel(self, channel: Channel.Channel) -> bool:
    ...
    def unfollowChannel(self, channel: Channel.Channel) -> bool:
    ...
    def joinChannel(self, channel: Channel.Channel) -> bool:
        pass
    
    def chatChannel(self, channel: Channel.Channel) -> bool:
        pass
